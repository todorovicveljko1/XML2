...
type ReservationServiceClient interface {
	...
	FilterReservation(ctx context.Context, in *FilterRequest, opts ...grpc.CallOption) (*AccommodationIds, error)
}
...
func (c *reservationServiceClient) GetReservation(ctx context.Context, in *GetReservationRequest, opts ...grpc.CallOption) (*Reservation, error) {
	out := new(Reservation)
	err := c.cc.Invoke(ctx, "/ReservationService/GetReservation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) CreateReservation(ctx context.Context, in *CreateReservationRequest, opts ...grpc.CallOption) (*Reservation, error) {
	out := new(Reservation)
	err := c.cc.Invoke(ctx, "/ReservationService/CreateReservation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) ApproveReservation(ctx context.Context, in *GetReservationRequest, opts ...grpc.CallOption) (*ReservationStatus, error) {
	...
	err := c.cc.Invoke(ctx, "/ReservationService/ApproveReservation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) RejectReservation(ctx context.Context, in *GetReservationRequest, opts ...grpc.CallOption) (*ReservationStatus, error) {
	out := new(ReservationStatus)
	err := c.cc.Invoke(ctx, "/ReservationService/RejectReservation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) CancelReservation(ctx context.Context, in *GetReservationRequest, opts ...grpc.CallOption) (*ReservationStatus, error) {
	out := new(ReservationStatus)
	err := c.cc.Invoke(ctx, "/ReservationService/CancelReservation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) FilterReservation(ctx context.Context, in *FilterRequest, opts ...grpc.CallOption) (*AccommodationIds, error) {
	out := new(AccommodationIds)
	err := c.cc.Invoke(ctx, "/ReservationService/FilterReservation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReservationServiceServer interface {
	...
	FilterReservation(context.Context, *FilterRequest) (*AccommodationIds, error)
...
func (UnimplementedReservationServiceServer) FilterReservation(context.Context, *FilterRequest) (*AccommodationIds, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FilterReservation not implemented")
}
...
func _ReservationService_GetReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ReservationService/GetReservation",
	}
...
func _ReservationService_CreateReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ReservationService/CreateReservation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_ApproveReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ReservationService/ApproveReservation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_RejectReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ReservationService/RejectReservation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_CancelReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ReservationService/CancelReservation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_FilterReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FilterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReservationServiceServer).FilterReservation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ReservationService/FilterReservation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReservationServiceServer).FilterReservation(ctx, req.(*FilterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReservationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FilterReservation",
			Handler:    _ReservationService_FilterReservation_Handler,
		},
	},
